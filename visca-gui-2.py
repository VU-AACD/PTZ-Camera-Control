...
Label(root, text='Store', height=6, width=6, bg=store_color).grid(row=1, column=store_column)
Button(root, text=1, width=7, height=7, bg=store_color, command=lambda: memory_set_function(0)).grid(row=2, column=store_column)
Button(root, text=2, width=7, height=7, bg=store_color, command=lambda: memory_set_function(1)).grid(row=3, column=store_column)


# Recall buttons and entries (as labels)
Label(root, text='Recall', width=7, height=7, bg=recall_color).grid(row=1, column=recall_column)
Button(root, text=1, width=7, height=7, bg=recall_color, command=lambda: memory_recall_function(0)).grid(row=2, column=recall_column)
Button(root, text=2, width=7, height=7, bg=recall_color, command=lambda: memory_recall_function(1)).grid(row=3, column=recall_column)
...
Button(root, text='Save preset labels', bg=store_color, command=save_preset_labels).grid(row=1, column=label_column, padx=5, pady=2)

# Pan and tilt buttons
Button(root, text='Up', width=10, height=10, bg=pan_tilt_color, command=lambda: send_message(pan_up)).grid(row=pan_tilt_row, column=pan_tilt_column+1)
Button(root, text='Left', width=10, height=10, bg=pan_tilt_color, command=lambda: send_message(pan_left)).grid(row=pan_tilt_row+1, column=pan_tilt_column)
Button(root, text='Right', width=10, height=10, bg=pan_tilt_color, command=lambda: send_message(pan_right)).grid(row=pan_tilt_row+1, column=pan_tilt_column+2)
Button(root, text='Down', width=10, height=10, bg=pan_tilt_color, command=lambda: send_message(pan_down)).grid(row=pan_tilt_row+2, column=pan_tilt_column+1)
Button(root, text='Up L', width=10, height=10, bg=pan_tilt_color, command=lambda: send_message(pan_up_left)).grid(row=pan_tilt_row, column=pan_tilt_column)
Button(root, text='Up R', width=10, height=10, bg=pan_tilt_color, command=lambda: send_message(pan_up_right)).grid(row=pan_tilt_row, column=pan_tilt_column+2)
Button(root, text='Down L', width=10, height=10, bg=pan_tilt_color, command=lambda: send_message(pan_down_left)).grid(row=pan_tilt_row+2, column=pan_tilt_column)
Button(root, text='Down R', width=10, height=10, bg=pan_tilt_color, command=lambda: send_message(pan_down_right)).grid(row=pan_tilt_row+2, column=pan_tilt_column+2)
Button(root, text='Stop', width=10, height=10, bg=pan_tilt_color, command=lambda: send_message(pan_stop)).grid(row=pan_tilt_row+1, column=pan_tilt_column+1)
...
Button(root, text='In', bg=zoom_color, width=button_width, height=button_height, command=lambda: send_message(zoom_tele)).grid(row=zoom_row+1, column=zoom_column)
Button(root, text='Stop', bg=zoom_color, width=button_width, height=button_height, command=lambda: send_message(zoom_stop)).grid(row=zoom_row+2, column=zoom_column)
Button(root, text='Out', bg=zoom_color, width=button_width, height=button_height, command=lambda: send_message(zoom_wide)).grid(row=zoom_row+3, column=zoom_column)
# Focus buttons
...
Button(root, text='On', bg=on_off_color, width=button_width, height=button_height, command=lambda: send_message(camera_on)).grid(row=on_off_row+1, column=on_off_column, padx=40)
Button(root, text='Connect', bg=on_off_color, width=button_width, height=button_height, command=reset_sequence_number_function()).grid(row=on_off_row+2, column=on_off_column)
Button(root, text='Off', bg=on_off_color, width=button_width, height=button_height, command=lambda: send_message(camera_off)).grid(row=on_off_row+3, column=on_off_column)
Button(root, text='Info Off', bg=on_off_color, width=button_width, height=button_height, command=lambda: send_message(information_display_off)).grid(row=on_off_row+4, column=on_off_column)
